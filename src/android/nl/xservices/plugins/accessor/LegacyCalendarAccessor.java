...
public class LegacyCalendarAccessor extends AbstractCalendarAccessor {
  ...
  protected EnumMap<KeyIndex, String> initContentProviderKeys() {
    ...
    keys.put(KeyIndex.CALENDARS_ACCOUNT_NAME, "account_name");
    keys.put(KeyIndex.CALENDARS_ACCOUNT_TYPE, "account_type");
    keys.put(KeyIndex.CALENDARS_OWNER_ACCOUNT, "ownerAccount");
    ...
    keys.put(KeyIndex.EVENTS_RDATE, "rDate");
